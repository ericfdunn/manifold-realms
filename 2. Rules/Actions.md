...
On your turn, you can take the following actions in any order:
- **move** a distance up to your speed
- one **standard action** or a second **move**
- one **bonus action**
- one **reaction** that takes place any time before the start of your next turn
...
When you take the Hide action, you make a Dexterity (Stealth) check in an attempt to hide, following the rules for hiding under Stealth in [[Abilities & Skills]]. If you succeed, you gain certain benefits:

- Attackers that can't see you have **disadvantage** on the attack roll. This is true whether they are guessing your location or are targeting you by some other sense. If they guess your location incorrectly, they automatically miss.
- When a creature can’t see you, you have **advantage** on attack rolls against it. However, you give away your location whether the attack hits or misses, so you are no longer hidden.

### Move

When you take the move action, you may move up to your speed.You can break up your movement on your turn, using some of your speed before and after your action. For example, if you have a speed of 30 feet, you can move 10 feet, take your action, and then move 20 feet.
...
Here are a few examples of the sorts of things you can do  
in tandem with your movement and action:
