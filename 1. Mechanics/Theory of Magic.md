...
- **Cultural and Spiritual Significance:** Magic might hold a deep cultural or spiritual significance that technology lacks. In this world, magical practices could be intertwined with the society’s beliefs, values, and traditions, making magic an integral part of life that technology cannot replace.
...
- **Inherent Instability of Physical Laws:** If the physical laws of your world are not constant but fluctuate – perhaps due to the influence of different planes or magical forces – this would make the development of consistent, reliable technology extremely challenging.
...
- **Elemental Entrapment Mechanic:**
    ...
    - **Entrapment Check:** Implement a check (e.g., Wisdom or Charisma) to determine if an elemental is entrapped during the device’s creation. The difficulty of this check depends on the power of the device.
    - **Consequences of Entrapment:** If an elemental is entrapped, roll on a table to determine its reaction – ranging from compliant (enhancing the device) to resistant (causing malfunctions) to hostile (actively seeking to destroy the device or escape).
